public class Program
{
    public static void Main(string[] args)
    {
        ...
        // UPGRADE: Inline Anonymous Method definition
        ProductFilterRule cheapRule = delegate(Product p) {
        ...
        // UPGRADE: Inlining the anonymous method directly into the method argument
        InventoryManager.PrintMatchingProducts(catalog, delegate(Product p) {
            return p.Stock == 0;
        });
    }
}
